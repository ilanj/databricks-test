...
```
databricks-cookie-cutter        <- Root directory. Both monorepo and polyrepo are supported.
│
├── databricks_test       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
