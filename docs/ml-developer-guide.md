...
Refer to [Local development and dev workspace](../databricks_test/databricks-resources/README.md#local-development-and-dev-workspace) 
...
You can iterate on the sample ML code by running the provided `databricks_test/training/notebooks/Train.py` notebook on Databricks using
