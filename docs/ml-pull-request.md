...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks-test-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-3830983824680797.17.azuredatabricks.net#mlflow/models/staging-databricks-test-model)
* [Prod workspace registered model](https://adb-3830983824680797.17.azuredatabricks.net#mlflow/models/prod-databricks-test-model)
